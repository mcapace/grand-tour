...
export const metadata: Metadata = {
  ...
  description:
    "Explore 200+ Grand Tour wines (Fri & Sat evenings). Daytime includes 10 AM & 2:30 PM seminars plus Sunday farewell breakfast.",
};
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-burgundy/30 to-charcoal py-16 sm:py-24 text-center px-4 sm:px-6">
        <h1 className="section-heading text-4xl sm:text-6xl md:text-8xl mb-4 text-balance">
          Wineries &amp; Wines
        </h1>
        <p className="font-sans text-gold text-xs uppercase tracking-[0.2em] mb-6">
          200+ Wines Rated 90 Points or Higher
        </p>
        <p className="font-sans text-cream/70 max-w-xl mx-auto leading-relaxed text-pretty px-1">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
          {cities.map((c) => (
            <div key={c.name} className="ticket-card p-5 sm:p-8 flex flex-col gap-4">
              <h2 className="section-heading text-3xl sm:text-4xl">{c.name}</h2>
      ...
      {/* Wine regions info */}
      <section className="bg-black/30 border-y border-gold/10 py-12 sm:py-16">
      ...
      <section className="py-12 sm:py-16 text-center px-4 sm:px-6">
        <h2 className="section-heading text-2xl sm:text-3xl mb-4">Get Your Tickets</h2>
        <p className="font-sans text-cream/60 text-sm mb-8 max-w-md mx-auto text-pretty">
